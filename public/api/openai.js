...
class OpenAI{
    ...
    static GetStatus(key){
        ...
        try{
            get("https://api.openai.com/v1/models/gpt-3.5-turbo-0301", options, (response) => {
    ...
    static MakePrompt( character, messages, user, settings, offset = 0 ){
        ...
        let token_count_system = GetTokens(_system).length;// + Utils.GetTokens(_command).length;
    ...
    static GetTokenConsumption( character, user ){
        ...
        let token_system = GetTokens(_system).length;// + Utils.GetTokens(_command).length
    ...
    static Generate(prompt, settings, swipe = false){
        ...
        try{
            ...
            const req = request( "https://api.openai.com/v1/chat/completions", options, (response) => {
